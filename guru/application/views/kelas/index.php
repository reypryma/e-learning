			...
			<table class="table table-no-border">
				...
				foreach ($kelas as $data) {
					...
					<tr>
						...
						<td width="50%"><a href="<?php echo base_url('kelas/detail/') . $data['id'] ?>"
										   class="btn btn-primary">Data Mahasiswa</a> <a
								href="<?php echo base_url('kelas/mapel/') . $data['id'] ?>" class="btn btn-primary">Data
								Mata Kuliah</a> <a href="<?php echo base_url('kelas/hapus/') . $data['id'] ?>"
												   class="btn btn-danger">Hapus Kelas</a></td>
					</tr>
				<?php } ?>
			</table>
		</div>
